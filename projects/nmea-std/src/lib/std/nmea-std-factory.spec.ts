import { NmeaFactory } from './nmea-std-factory';

describe('NmeaFactory', () => {
  it('should error on constructor.', () => {
    try {
      const factory: NmeaFactory = new NmeaFactory();
      fail();
    } catch (error) {
      // TODO: check message.
  ...
  it('should create an GBQ instance', () => {
    ...
    const nmea = NmeaFactory.create(input);
    expect(nmea).toBeTruthy();
